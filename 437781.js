// ==UserScript==
// @name         [ecust] 🥇超星/学习通网课小助手|修复视频播放|自动跳转任务点|章测字体解密|自动答题|题库覆盖率高|逐渐支持更多平台
// @namespace    noshuang
// @version      4.3.1
// @author       noshuang
...
const consoleScript = `window.addEventListener("mouseout",t=>{t.stopImmediatePropagation(),t.stopPropagation(),t.preventDefault()},!0);`;
    ...
    runConsoleScript();  function checkLessons() {
